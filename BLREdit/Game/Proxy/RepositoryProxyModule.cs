...
{
    //public RepositoryType RepositoryProvider { get; set; } = RepositoryType.Gitlab;
    ...
    //    get
    //    {
    //        if (RepositoryProvider == RepositoryType.GitHub)
    //        {
    ...
    //    get
    //    {
    //        if (RepositoryProvider == RepositoryType.Gitlab)
    //        {
