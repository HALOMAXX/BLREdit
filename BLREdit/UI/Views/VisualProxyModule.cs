...
//                    {
//                        LoggingSystem.Log($"Replacing {client.InstalledModules[i]}");
//                        client.InstalledModules.RemoveAt(i);
//                        i--; // reduce index by one to stay within InstalledModule Count and to not skip any
//                    }
//                }
