namespace BLREdit
{
    public class Weapon
    {
        ...
        private static readonly Weapon[] DefaultWeapons = new Weapon[]
        {
            ...
            new Weapon() { Barrel = DefaultBarrel,                          Grip = "", Magazine = 140,  Muzzle = 9,     Receiver = "Burstfire SMG",             Stock = DefaultStock,                           Scope="Titan Rail Sight", Tag=0, Camo=0 },             // 3  Burstfire SMG
